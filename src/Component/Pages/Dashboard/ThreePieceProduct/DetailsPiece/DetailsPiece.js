...
import Navigation from '../../../Homes/Navigation/Navigation';
...
const DetailsPiece = () => {
    ...
    useEffect(()=>{
        fetch(`https://fierce-wildwood-21631.herokuapp.com/threePices/${id}`)
        .then(res=>res.json())
   ...
   <input {...register("name", { required: true})} placeholder="name" defaultValue={details.name} />
